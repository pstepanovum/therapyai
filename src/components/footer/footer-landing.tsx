...
const FooterDashboard = () => {
	...
	const footerSections = [
		...
		},
		{
			...
			links: [
				{ label: 'About Us', href: '/' },
				{ label: 'Mental Health Blog', href: '/' },
				{ label: 'Success Stories', href: '/' },
				{ label: 'Counselor Partnership', href: '/' },
		...
		},
		{
			...
			links: [
				...
				{ label: 'Counselor Community', href: '/' },
				{ label: 'Patient Resources', href: '/' },
				{ label: 'Mental Health Events', href: '/' },
